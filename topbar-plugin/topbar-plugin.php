...
/**
* Plugin Name: topbar-plugin
*Description: ett plugin som lägger till en box i toppen av din sida, är du inloggad säger den välkomen tillbaka är du utloggad kan man skriva önskat meddelande inne på wordpress admin sida.
*version: 1.0
*Author: Mimmie Sonntag
**/
...
function get_user_or_websitename()
{
    ...
    else
    {
        ...
        return 'Välkommen tillbaka ' . $current_user -> user_login;
    }
}
...
function tb_css()
{
    echo '
        <style>
        h3.tb {color: #fff; margin: 0; padding: 30px; text-align: center; background: red}
        </style>
    ';
}

//Top Bar Plugin sida, knapp i menyn på admin panelen. 
//inne på topbar sidan kan man skriva text, den text man skriver där syns om man är utloggad. 
